...
uint8_t condition_code_to_text_size(uint8_t condition_code) {
  static const uint8_t lookup[NUM_CONDITION_CODES] = {23,17,23,15,9,15,16,26,20,26,15,9,15,20,14,20,25,31,16,12,15,12,17,14,15,19,13,19,20,12,6,12,7,14,21,15,19,13,19,6,7,6,19,5,6,6,14,9,9,11,12,18,15,17,9,16,11,6,5,7,6,6,14,15,17,14,15,22,6,13,7,15,11,17,13,14,13,17,6,9};
